...
class LogReader:
    ...
    def _read_json_logs(self, log_file_path: str, chunk_size: int = 10) -> Iterator[tuple[dict[str, Any], int, int, list[list[int]] ]]:
        byte_read = 0
        decoder = json.JSONDecoder()
        buffer = ""
        total_file_size_byte = os.path.getsize(log_file_path)
        start_position = 0; length = 0; pending_whitespaces = 0; 
        json_obj_indices = []
